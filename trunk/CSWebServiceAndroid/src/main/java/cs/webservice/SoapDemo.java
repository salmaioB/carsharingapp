    ...
    public void commandAction(Command c, Displayable s) {
        if (c == getCommand) {
        	...
        	try {
                ...
                AndroidHttpTransport ht = new AndroidHttpTransport("http://localhost:8888/axis/services/AxisService");
                ht.call("", envelope);

                SoapObject ret = new SoapObject("http://cs.webservice.impl","CustomObject");
