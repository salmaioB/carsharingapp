...
<form method="POST" class="saveOffer_form" id="saveOffer_form">
	<table>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<input value="<s:property value="datepickerPostt" />" readonly="readonly" id="datepickerPostDate" name="datepickerPostDate" class="" size="20"/>
			</td>
		</tr>
		<tr>
			<td>
