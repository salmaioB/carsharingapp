	...
	<form method="post" id="post_form_etape_2">
		<table>
			...
			<tr>
				...
				<td>
					<input onkeydown="activeInput('villepassage1Post','villepassage2Post','priceTrip1');" id="villepassage1Post" name="villepassage1Post" class="" size="20"/>
			...
			<tr>
				...
				<td>
					<input onkeydown="activeInput('villepassage2Post','villepassage3Post','priceTrip2');" disabled="disabled" id="villepassage2Post" name="villepassage2Post" class="" size="20"/>
			...
			<tr>
				...
				<td>
					<input onkeydown="activeInput('villepassage3Post','villepassage4Post','priceTrip3');" disabled="disabled" id="villepassage3Post" name="villepassage3Post" class="" size="20"/>
			...
			<tr>
				...
				<td>
					<input onkeydown="activeInput('villepassage4Post','villepassage5Post','priceTrip4');" disabled="disabled" id="villepassage4Post" name="villepassage4Post" class="" size="20"/>
			...
			<tr>
				...
				<td>
					<input onkeydown="activeInput('villepassage5Post','villepassage6Post','priceTrip5');" disabled="disabled" id="villepassage5Post" name="villepassage5Post" class="" size="20"/>
			...
			<tr>
				...
				<td>
					<input onkeydown="activeInput('villepassage6Post','villepassage7Post','priceTrip6');" disabled="disabled" id="villepassage6Post" name="villepassage6Post" class="" size="20"/>
			...
			<tr>
				...
				<td>
					<input onkeydown="activeInput('villepassage7Post','villepassage8Post','priceTrip7');" disabled="disabled" id="villepassage7Post" name="villepassage7Post" class="" size="20"/>
			...
			<tr>
				...
				<td>
					<input onkeydown="activeInput('villepassage8Post','villepassage8Post','priceTrip8');" disabled="disabled" id="villepassage8Post" name="villepassage8Post" class="" size="20"/>
