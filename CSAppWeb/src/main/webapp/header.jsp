...
<span style="float:right;">
	<table>
		<tr>
			<td>
				<a href="http://<%=cs.define.Define.adresse%>:<%=cs.define.Define.port%>/CSAppWeb/Accueil?langage=fr">
					<img src="img/flag_FR.jpg" height="60px;"/>
				</a>
			</td>
			<td>
				<a href="http://<%=cs.define.Define.adresse%>:<%=cs.define.Define.port%>/CSAppWeb/Accueil?langage=en">
